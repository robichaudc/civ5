...
print"Loading Staging Room Screen"
...
function UpdatePlayer( slotInstance, playerInfo )
	...
	if(slotInstance ~= nil) then
		...
		--------------------------------------------------------------
		-- Set Handicap
		local tHandicap = GameInfo.HandicapInfos[ PreGame.GetHandicap( playerID ) ]
...
function ShowHideHandler( bIsHide, bIsInit )
	...
	--print("ShowHideHandler Hide: ", bIsHide, " Init: ", bIsInit )
	...
	Controls.AtlasLogo:SetHide( bIsHide or not IsInGameScreen() )
