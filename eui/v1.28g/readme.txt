Enhanced User Interface DLC Version 1.28g (March 21st 2016)
...
You may download this program from http://forums.civfanatics.com/downloads.php?do=file&id=21929 and use it free of charge for non-profit private use at your sole risk (no warranty expressed or implied).
...
Specifically, you are NOT allowed to re-use this code to make another "Enhanced User Interface" more to "your" liking (please write your own), host this program on collaborative websites such as GitHub, distribute this program via other websites than my choice (Civ Fanatics), distribute older versions etc...
...
http://www.youtube.com/watch?v=Ud_wH4Q8W9I (there are several other install tutorials on youtube)
1.	make sure your game is up to date at version 1.0.3.144 or later (EUI DLC is incompatible with older game versions such as 1.0.3.18)
...
6.	extract from the downloaded zip and:
	- copy the UI_bc1 folder to the game's DLC folder (step 4). There can only be one such folder in the entire ...\sid meier's civilization v\ folder tree, and it MUST be in the correct location: ...\Steam\SteamApps\common\sid meier's civilization v\assets\DLC
...
13.	you are welcome to report bugs or suggest possible improvements at http://forums.civfanatics.com/showthread.php?p=12847246

------------------
GAME COMPATIBILITY
------------------

Compatible ONLY with game version 1.0.3.144 or later (EUI DLC is incompatible with older game versions such as 1.0.3.18)
...
2.	Make sure your game is up to date at version 1.0.3.144 or later (EUI DLC is incompatible with older game versions such as 1.0.3.18)
