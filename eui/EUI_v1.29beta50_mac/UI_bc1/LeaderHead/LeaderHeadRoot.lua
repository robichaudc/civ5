...
local g_InstanceManager = StackInstanceManager( "Leader Button", "Button", Controls.LeaderStack )
...
Controls.Button:SetToolTipType( "EUI_CivilizationTooltip" )
Controls.Button:SetToolTipCallback( function() return LuaEvents.CivilizationToolTips.Call( Controls.Button, g_diploPlayerID ) end )
